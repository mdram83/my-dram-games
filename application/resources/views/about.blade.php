<x-app-layout>
    ...
    <div class="container">
        ...
        <h2 class="text-white text-4xl font-['Oswald']'] mt-4">About this website</h2>
        <p>bla bla</p>

        <h2 class="text-white text-4xl font-['Oswald']'] mt-4">Terms of use</h2>
        <p>bla bla</p>

        <h2 class="text-white text-4xl font-['Oswald']'] mt-4" id="privacy">Privacy</h2>
        <p>bla bla</p>
    </div>

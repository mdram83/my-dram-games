...
interface PlayingCardDealer
{
    ...
    public function getCardsByKeys(CollectionPlayingCard $deck, ?array $keys, bool $unique = false, bool $strict = false): CollectionPlayingCardUnique|CollectionPlayingCard;

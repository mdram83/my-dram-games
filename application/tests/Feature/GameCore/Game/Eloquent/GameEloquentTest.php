...
use App\GameCore\Game\Eloquent\GameEloquent;
...
class GameEloquentTest extends TestCase
{
    ...
    protected \App\GameCore\Game\Eloquent\GameEloquent $game;
    ...
    {
        $this->assertInstanceOf(\App\GameCore\Game\Eloquent\GameEloquent::class, $this->game);
    }
    ...
    {
        $this->expectException(\App\GameCore\Game\GameException::class);

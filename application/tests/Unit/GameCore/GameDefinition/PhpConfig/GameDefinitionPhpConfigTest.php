...
namespace Tests\Unit\GameCore\GameDefinition\PhpConfig;

use App\GameCore\GameDefinition\GameDefinition;
use App\GameCore\GameDefinition\GameDefinitionException;
use App\GameCore\GameDefinition\PhPConfig\GameDefinitionPhpConfig;
...
class GameDefinitionPhpConfigTest extends TestCase
{
    ...
    public function testGameDefinitionCreated(): void
    {
        ...
        $gameConfig = new \App\GameCore\GameDefinition\PhPConfig\GameDefinitionPhpConfig($this->slug);
    ...
    public function testThrowExceptionIfNoNameInConfig(): void
    {
        ...
        new \App\GameCore\GameDefinition\PhPConfig\GameDefinitionPhpConfig($this->slug);
    }
    ...
    public function testGetNumberOfPlayersDecriptionWithOneNumber(): void
    {
        ...
        $this->mockConfigFacade($definition);
        $gameDefinition = new \App\GameCore\GameDefinition\PhPConfig\GameDefinitionPhpConfig($this->slug);
